...
const TodoList = () => {
  ...
  const [linkType, setLinkType] = useState("Todo List 2");
      ...
      {!error && !loading && (
        <div>
          <div className='flex justify-between my-5'>
            <button
              disabled={linkType === "Todo List 1"}
              onClick={() => setLinkType("Todo List 1")}
              className='button small'
            >
              Todo List #1:
            </button>
            <button
              disabled={linkType === "Todo List 2"}
              onClick={() => setLinkType("Todo List 2")}
              className='button small'
            >
              Todo List #2
            </button>
